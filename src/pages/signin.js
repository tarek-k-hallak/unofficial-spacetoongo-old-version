                ...
                <section>
                    <div className='flex justify-between m-auto bg-background rounded-[50px] mx-4 border-2 border-white'>
                        <div className='flex flex-col mx-auto w-[400px] justify-between h-[600px]'>
                            ...
                            <div className='flex flex-row mx-auto w-[90%]'>
                                <button className='w-[30%] h-10 bg-background border-primary text-primary font-semibold border-2 text-center text-sm lg:text-lg rounded-full hover:bg-primary hover:text-white transform duration-200 mr-2'>{SignInData.facebook}</button>
                                <button className='w-[30%] h-10 bg-background border-primary text-primary font-semibold border-2 text-center text-sm lg:text-lg rounded-full hover:bg-primary hover:text-white transform duration-200 mr-2'>{SignInData.google}</button>
                                <button className='w-[30%] h-10 bg-background border-primary text-primary font-semibold border-2 text-center text-sm lg:text-lg rounded-full hover:bg-primary hover:text-white transform duration-200'>{SignInData.apple}</button>
                            </div>
                            <div className='mb-6 text-right mx-auto'>
